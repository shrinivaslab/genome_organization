...
## 25Kb, 1Mb window
command = f"java -jar /Users/kadendimarco/Desktop/Shrivinas_lab/genome_archetecture/utilis/tools/juicer/scripts/common/juicer_tools.jar apa -k KR -r 25000 -o -w 20 -e {file_name} {loops_file} {folder_name}"
