...
def main(args):
    ...
    chains = [(0,6000,False), (6000,12000,False), (12000,18000,False), (18000,24000,False),
              (24000,30000,False), (30000,36000,False), (36000,42000,False), (42000,None,False)]

    monomer_types = np.load(args.monomer_types).flatten()
